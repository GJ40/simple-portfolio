    ...
    return (
        <section id="about" className="max-w-4xl mx-auto px-4 py-20">
            ...
            <p className="text-lg leading-relaxed text-justify">
                I am a passionate software developer with a strong foundation in computer science. I completed my education at Walchand Institute of Technology, Solapur, where I majored in Computer Science and Engineering. My interests include building interactive web applications and exploring new technologies. I have experience in frontend frameworks like React and backend development with Node.js.
            </p>
                ...
                <li>
                    ...
                    <ul className='list-disc ml-6 my-2'>
                        <li className='my-2'>
                            ...
                            <pre>
                                MEAN Stack Developer, Contributed to the development of BidNow: Real-Time Auction Experience, a MEAN stack web application.<br />
                        ...
                        <li className='my-2'>
                            ...
                            <pre>
                                Learned the concepts of Google Cloud, Google Gemini, Responsible AI and principles.<br />
