...
const Home = () => {
    return (
        <section id="home" className="min-h-screen flex flex-col items-center justify-center text-center px-4">
            <img src={profilePic ? profilePic : reactSVG} alt="Profile" className="w-40 h-40 rounded-full mb-6 shadow-lg" />
            ...
            <a href={Pdf ? Pdf : '#home'} target="_blank" className="mt-6 inline-block bg-blue-600 text-white px-6 py-2 rounded hover:bg-blue-700 transition">
                View Resume
            </a>
        </section>
    );
